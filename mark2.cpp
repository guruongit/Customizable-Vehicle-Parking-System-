...
public:
    ...
    void get_parking_details()
    {
        ...
        vector<pair<int, int>> g[no_parking_slots + 1];
        ...
        for (int i = 0; i < no_interconnected_slots; i++)
        {
            ...
            cin >> distance;
            g[first_point].push_back(make_pair(second_point, distance));
            g[second_point].push_back(make_pair(first_point, distance));
        }
...
public:
    void user_menu()
    {
        int choice;
        fstream f;
        f.open("user_detailss.txt", ios::in | ios::out | ios::binary);
        do
        {
            cout << "\nUser Menu\n";
        ...
        if (strcmp(pass, password) == 0)
        {
            ...
            do
            {
                ...
                case 2:
                    ...
                    cout << "\nNumber of empty slots: " << empty_slots+1;
                    cout << "\nNumber of occupied slots: " << p.no_parking_slots - empty_slots-1;
                    break;
                case 3:
                    f.seekg(0);
